...
$string['modulename_help'] = 'The HUB activity module enables you to create interactive content such as Interactive Videos, Question Sets, Drag and Drop Questions, Multi-Choice Questions, Presentations and much more.

In addition to being an authoring tool for rich content, HUB enables you to import and export HUB files for effective reuse and sharing of content.

User interactions and scores are tracked using xAPI and are available through the Moodle Gradebook.

You add interactive HUB content by creating content using the built-in authoring tool or uploading HUB files found on other HUB enabled sites.';
$string['modulename_link'] = 'https://cinecorpativo.pe';
$string['modulenameplural'] = 'Interactive Content';
$string['pluginadministration'] = 'HUB';
$string['pluginname'] = 'HUB';
$string['intro'] = 'Introduction';
$string['h5pfile'] = 'HUB File';
...
$string['downloadtitle'] = 'Download this content as a HUB file.';
$string['copyrighttitle'] = 'View copyright information for this content.';
$string['embedtitle'] = 'View the embed code for this content.';
$string['h5ptitle'] = 'Visit cinecorporativo.pe to check out more cool content.';
...
$string['lookforupdates'] = 'Look for HUB updates';
$string['updatelibraries'] = 'Update All Libraries';
$string['removetmpfiles'] = 'Remove old HUB temporary files';
$string['removeoldlogentries'] = 'Remove old HUB log entries';

// Admin settings.
$string['displayoptionnevershow'] = 'Never show';
$string['displayoptionalwaysshow'] = 'Always show';
$string['displayoptionpermissions'] = 'Show only if user has permissions to export HUB';
$string['displayoptionpermissionsembed'] = 'Show only if user has permissions to embed HUB';
...
$string['disablehubdescription'] = "It's strongly encouraged to keep this option enabled. The HUB Hub provides an easy interface for getting new content types and keeping existing content types up to date. In the future, it will also make it easier to share and reuse content. If this option is disabled you'll have to install and update content types through file upload forms.";
$string['empty'] = 'Empty';
...
$string['sendusagestatistics_help'] = 'Usage statistics numbers will automatically be reported to help the developers better understand how HUB is used and to determine potential areas of improvement.';
...
$string['settings'] = 'HUB Settings';
$string['libraries'] = 'HUB Libraries';

// Content type cache section.
$string['ctcacheconnectionfailed'] = "Couldn't communicate with the HUB Hub. Please try again later.";
$string['ctcachenolibraries'] = 'No content types were received from the HUB Hub. Please try again later.';
...
$string['validatingh5pfailed'] = 'Validating HUB package failed.';
...
$string['noanswersubmitted'] = 'This user hasn\'t submitted an answer to the HUB yet';
...
$string['hvp:installrecommendedh5plibraries'] = 'Install new safe HUB content types recommended';
...
$string['welcomegettingstarted'] = 'To get started with HUB and Moodle take a look at our <a {$a->moodle_tutorial}>tutorial</a> and check out the <a {$a->example_content}>example content</a> at HUB.org for inspiration.';
...
// Privacy.
$string['privacy:metadata:core_files'] = 'The HUB activity stores files which have been uploaded as part of HUB content.';
$string['privacy:metadata:core_grades'] = 'The HUB activity stores grades of users that have answered HUB content.';
...
$string['privacy:metadata:hvp_content_user_data:hvp_id'] = 'The ID of the HUB content that the data belongs to.';
$string['privacy:metadata:hvp_content_user_data:sub_content_id'] = 'Sub-content of HUB, 0 if this is not sub-content.';
...
$string['privacy:metadata:hvp_events'] = 'Keeps track of logged HUB events.';
...
$string['privacy:metadata:hvp_xapi_results'] = 'Stores xAPI events in HUB content.';
...
$string['privacy:metadata:hvp_xapi_results:additionals'] = 'Additional information that the HUB can send in.';
