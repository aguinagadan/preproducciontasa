H5PEditor.language.core = {
  ...
  addVideoDescription: 'HUB supports all external video sources formatted as mp4, webm or ogv, like Vimeo Pro, and has support for YouTube links.',
  insert: 'Insert',
  cancel: 'Cancel',
  height: 'height',
  width: 'width',
  ...
  uploadInstructionsTitle: 'Upload an HUB file.',
  ...
  h5pFileWrongExtensionContent: 'Only files with the .HUB extension are allowed.',
  h5pFileValidationFailedTitle: 'Could not validate HUB file.',
  h5pFileValidationFailedContent: 'Make sure the uploaded HUB contains valid HUB content. HUB' +
  ' files containing only libraries should be uploaded through the HUB Libraries page.',
  h5pFileUploadServerErrorTitle: 'The HUB file could not be uploaded',
  ...
  noContentTypesAvailableDesc: 'Your site is having difficulties connecting and listing the available content types.',
  contentTypeCacheOutdated: 'Content type list outdated',
  contentTypeCacheOutdatedDesc: 'Your site is having difficulties connecting to check for content type updates. You may not be able to update or install new content types.',
  tryAgain: 'Try again'
};
