...
$string['enableimgsinglecourse'] = 'Habilitar imagen en una página de un solo curso.';
$string['enableimgsinglecoursedesc'] = 'Desmarque para deshabilitar el formateo de la imagen en la página de un solo curso.';
...
$string['loginsettings'] = 'Configuración de la pagina de ingreso';
...
$string['discussionreplies'] = 'Réplicas';
...
$string['nocommoncourses'] = 'Usted no comparte ningun curso en común con este usuario.';
...
$string['recentfeedback'] = 'Feedback Recientes';
...
$string['fontname'] = 'Fuentes';
$string['fontnamedesc'] = 'Ingrese el nombre exacto de la fuente para usar en Moodle.';
$string['followus'] = 'Síguenos';
$string['poweredby'] = '';
$string['signin'] = 'Ingresar';
$string['forgotpassword'] = '¿Perdiste tu contraseña?';
$string['noaccount'] = '¿No tienes una cuenta?';
$string['applysitewide'] = 'Aplicar a todo el sitio';
...
$string['enteremailid'] = 'Por favor, introduzca su Email ID.';
$string['enterproperemailid'] = 'Por favor, introduzca un Email ID válido.';
...
$string['sendfeedback'] = 'Enviar Feedback';
$string['recentnews'] = 'Novedades';

/* My Course Page */
$string['resume'] = 'Reanudar';
$string['start'] = 'Comenzar';
$string['completed'] = 'Teminado';

/* Dashboard Page */
$string['welcome-msg'] = 'Bienvenido';
...
$string['overdue'] = "Completadas";
$string['upcoming'] = "Pendientes";
$string['expired'] = 'Atrasadas';
$string['selectcourse'] = "Seleccionar curso";
$string['courseanlytics']="Análisis de cursos";
...
$string['coursestats'] = "Estadísticas";
