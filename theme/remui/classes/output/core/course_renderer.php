...
class course_renderer extends \core_course_renderer
{
    ...
    public function course_section_cm_list($course, $section, $sectionreturn = null, $displayoptions = array())
    {
        ...
        if (!empty($sectionoutput)) {
            // --- MIDECO AQUI MODIFICAMOS EL ESTILO DE LISTA POR BOX
            $output .= html_writer::tag('ul', $sectionoutput, array('class' => 'section mideco-section img-text p-0 list-group list-group-dividered list-group-full'));
    ...
    public function course_first_section_cm_list_item($course, &$completioninfo, cm_info $mod, $sectionreturn, $displayoptions = array())
    {
        ...
        if ($modulehtml = $this->course_first_section_cm($course, $completioninfo, $mod, $sectionreturn, $displayoptions)) {
            $modclasses = 'activity first-section-activity ' . $mod->modname . ' modtype_' . $mod->modname . ' col-12 col-sm-6 col-md-4 col-lg-2 justify-content-center p-0 pt-40' . $mod->extraclasses;
            $output .= html_writer::tag('li', $modulehtml, array('class' => $modclasses, 'id' => 'module-' . $mod->id));
        }
        return $output;
    }
