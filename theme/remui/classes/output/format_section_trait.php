...
trait format_section_trait
{
    ...
    protected function first_section_header($section, $course, $onsectionpage, $sectionreturn = null)
    {
        ...
        $o .= "<div class='p-10 course-cover-image pb-30' style='background-image: linear-gradient(to top, rgba(24, 74, 125, 0.5), rgba(24, 74, 125, 1.0)), url(".$imagesrc.");' alt='".$imagealt."''>
        $leftside
        $rightside
        <div class='text-white'>
            <div class='page-title text-center my-15'>".$course->fullname."</div>
            <div class='page-title-seccion0 text-center my-15'>".get_section_name($course, $section)."</div>
