...
class utility
{
  ...
  // send customer feedback to RemUI team.
    ...
    public static function get_courses_view_toggler()
    {
        ...
        if ($view == 'grid') {
            $grid = html_writer::start_tag('a', array('class' => 'grid_btn btn active togglebtn btn-primary', 'title' => 'Grid view'));
            $list = html_writer::start_tag('a', array( 'class' => 'list_btn btn togglebtn btn-primary', 'title' => 'List view'));
        } else {
            $grid = html_writer::start_tag('a', array('class' => 'grid_btn btn  togglebtn btn-primary', 'title' => 'Grid view'));
            $list = html_writer::start_tag('a', array( 'class' => 'list_btn btn  togglebtn btn-primary active', 'title' => 'List view'));
        }
